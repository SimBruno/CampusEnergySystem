...
### Scenario 1 CAPEX
For the first scenario, the capital expenditure is minimized. The table below summarizes the different utilities which are chosen by the model, and their corresponding heat load:
