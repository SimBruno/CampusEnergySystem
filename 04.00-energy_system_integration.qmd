...
fig = fig.update_layout(title='Price Vector Plot with TOTEX objective', xaxis_title='Gas price (CHF/kWh)', yaxis_title='TOTEX (CHF/y)', showlegend = False)
fig.show()
```

pareto if ng price at 0.291 CHF/kWh
