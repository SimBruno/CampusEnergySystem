...
ampl.cd("C:/Users/coren/Desktop/report-group-3/report-group-3-jamil-codes_04_energy_system_integration/ampl_files/") # select the right folder
...
```{python}
import sys
sys.path.append('C:/Users/coren/Desktop/report-group-3/report-group-3-jamil-codes_04_energy_system_integration/')
...
```{python}
import pandas as pd
myData = pd.read_pickle("C:/Users/coren/Desktop/report-group-3/report-group-3-jamil-codes_04_energy_system_integration/results/scenario1.pkl")
myData["Totalcost"]
print(myData["mult"])
print(myData["use"])
print(myData["Ebuilding"])
print(myData["Edemand"])
```
