...
DC_payback  = round(DC_CAPEX/(ref_TOTEX-DC_OPEX),2)
...
The cost reduction is `r reticulate::py_eval("f'{ref_TOTEX-DC_TOTEX:.2f}'")` [CHF/y].
...
vent_payback  = round(vent_CAPEX/(ref_OPEX-vent_OPEX),2)
...
vent_HP_payback  = round(vent_HP_CAPEX/(vent_HP_OPEX-ref_OPEX),2)
