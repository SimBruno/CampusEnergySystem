...
totopex = run_ampl(data_file, model_directory, model_file)
...
TC = run_ampl(data_file, model_directory, model_file)

#totalcost = ampl.getVariable("TC")
...
```{python, eval = F, echo = F, results = 'show'}
#| label: ampl-vent
