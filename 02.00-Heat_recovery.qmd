...
print("The TOTOPEX for reference case is:", round(ref_data['Totopex'],2), "CHF.\n")
...
html_table_ref_data += f"<tr><td>Objective</td><td>{round(ref_data['Totopex'],2)} CHF</td></tr>\n"
...
model_directory = "2.DC_recovery_Mirco"
...
html_table_dc_data += f"<tr><td>Objective</td><td>{round(DC_data['obj'],2)} CHF</td></tr>\n"
html_table_dc_data += f"<tr><td>HEX Area</td><td>{round(DC_data['AHEDC'],2)} m<sup>2</sup></td></tr>\n"
...
html_table_vent_data += f"<tr><td>TOTEX</td><td>{round(vent_data['obj'],2)} CHF</td></tr>\n"
html_table_vent_data += f"<tr><td>OPEX</td><td>{round(vent_data['OPEX'],2)} CHF</td></tr>\n"
html_table_vent_data += f"<tr><td>CAPEX</td><td>{round(vent_data['CAPEX'],2)} CHF</td></tr>\n"
html_table_vent_data += f"<tr><td>A<sub>vent</sub></td><td>{round(vent_data['Area_Vent'],2)} m<sup>2</sup></td></tr>\n"
...
model_directory = "4.Ventilation_HP_SAL"
...
html_table_vent_HP_data += f"<tr><td>TOTEX</td><td>{round(vent_HP_data['obj'],2)} CHF</td></tr>\n"
html_table_vent_HP_data += f"<tr><td>OPEX</td><td>{round(vent_HP_data['OPEX'],2)} CHF</td></tr>\n"
html_table_vent_HP_data += f"<tr><td>CAPEX</td><td>{round(vent_HP_data['CAPEX'],2)} CHF</td></tr>\n"
html_table_vent_HP_data += f"<tr><td>A<sub>vent</sub></td><td>{round(vent_HP_data['Area_Vent'],2)} m<sup>2</sup></td></tr>\n"
