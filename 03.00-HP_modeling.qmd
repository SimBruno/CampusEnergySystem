...
The better performing heat pumps are those with propylene as a working fluid, but they are also the most expansive. The investment costs $cinv1$ and $cinv2$, as well as the coefficients $a$,$b$,$c$  will be used for the next section in all double stage heat pump models, for the assessment of the whole EPFL energy system. We will let the model decide which heat pump to use.
